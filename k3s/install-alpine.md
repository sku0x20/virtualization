...
> **Cloud-init caveat:** Alpine's tiny-cloud implementation only supports a subset of cloud-init. Setting a password via cloud-init user-data (`chpasswd`, `password:`) is **not supported** — access requires an SSH key.
